...
### Общие данные
- Название основного репозитория: OBJV2
- Описание проекта: Общий проект студентов группы

### Данные участников
Тимлид:
- Логин на GitHub: Dedyretti
- Полный путь к локальной папке проекта: C:\Users\Student\Desktop\OBJV2\OBJV2-1

Падаван:
- Логин на GitHub: Mayis25
- Полный путь к локальной папке проекта: C:\Users\Student\Desktop\OBJV2
...
- Действие 2.1: Перейти к основному репозиторию
  - Команда: Переход по ссылке: https://github.com/Dedyretti/OBJV2.git
...
Штатный результат: Создан форк по адресу: https://github.com/Mayis25/OBJV2.git с пометкой "forked from [логин_тимлида]/[название_репозитория]"
...
Вводная часть: Тимлид проверяет измен
ения и принимает их в основной репозиторий.
...
- **Основной репозиторий:** `https://github.com/Dedyretti/OBJV2.git`
- **Форк падавана:** `https://github.com/mayis25/OBJV2.git`
...
git clone https://github.com/dedyretti/OBJV2.git
cd C:\Users\Student\Desktop\OBJV2

Результаты:
- URL основного репозитория: https://github.com/Dedyretti/OBJV2.git
...
|---|---------|-------|--------|---------|
| 1 | Mayis25 | Feature/add new fil | ✅  Открыт ❌ Принят ❌ Отклонен | https://github.com/Dedyretti/OBJV2/pull/2 |
...
* 
574091e (HEAD -> main, origin/main, origin/HEAD) Исправление основного отчета
* f20a050 исправлен ридми
* 040ae63 исправлена ошибка с запуском программы
* 963d384 Версия 2.0 Исправлены ошибки дополнен функционал
* 4f1dc28 Изменено созранение анкеты
* 632dd12 измениения рид ми
* 507ee8b Релиз программ анкетирования
...
* | 34ca924 Тимлидотчет
* | 95ccf97 Добавлен файл .gitignore
* | adb89c9 Merge branch 'main' of https://github.com/Dedyretti/OBJV2
|\| 
| *   7909826 Merge pull request #1 from mayis25/feature/add-new-file
| |\  
| | * 27bc77a Добавлен новый функционал
| |/  
* / 124f1bc гит игнор
|/  
* 71b2332 Initial commit
